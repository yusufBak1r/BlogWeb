    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AbuotID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Abouts", x => x.AbuotID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WriteID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WriteName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WriteAbout = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WriteImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WriteMail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WritePassword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WriteStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Writes", x => x.WriteID);
                });
        }
